...
public interface CovoiturageRepository extends JpaRepository<Covoiturage, Integer> {
	...
	public List<Covoiturage> findByAdresseDepartAndAdresseArriveeAndDateDepart(Adresse adresseDepart,
			Adresse adresseArrivee, LocalDateTime dateDepart);
	...
	// public List<Covoiturage> findByCollaborateurs(List<Collaborateur>
	// collaborateurs); //ici query avec un join

	@Query("SELECT c FROM Covoiturage c WHERE c.dateDepart BETWEEN :startOfDay AND :endOfDay AND c.dateDepart > CURRENT_DATE")
	public List<Covoiturage> findBeetweenStartOfDaytAndEndOfDay(@Param("startOfDay") LocalDateTime startOfDay,
			@Param("endOfDay") LocalDateTime endOfDay);

	/**
	 * @method qui selectionne tous les covoiturages par collaborateur
	 */
	 ...
	 * ) public List<Covoiturage>
	 * findByAllCoivoituragesByCollaborateurs(@Param("collaborateur") Collaborateur
	 * collaborateur);
	 */

	@Query("SELECT DISTINCT c FROM Covoiturage c WHERE c.dateDepart > CURRENT_TIMESTAMP AND c.organisateur.id = :organisateurId")
	...
	@Query("SELECT c FROM Covoiturage c WHERE c.adresseDepart.id =:adresseDepartId OR c.adresseArrivee.id =:adresseArriveeId AND c.dateDepart BETWEEN :startOfDay AND :endOfDay AND c.dateDepart > CURRENT_DATE")
	public List<Covoiturage> findBeetweenStartOfDaytAndEndOfDayAndAdresseDepartOrAdresseArrivee(
			@Param("startOfDay") LocalDateTime startOfDay, @Param("endOfDay") LocalDateTime endOfDay,
			@Param("adresseDepartId") Integer adresseDepartId,
			@Param("adresseArriveeId") Integer adresseArriveeId);
	
	@Query("SELECT c FROM Covoiturage c WHERE c.adresseDepart.id =:adresseDepartId AND c.adresseArrivee.id =:adresseArriveeId AND c.dateDepart BETWEEN :startOfDay AND :endOfDay AND c.dateDepart > CURRENT_DATE")
	public List<Covoiturage> findBeetweenStartOfDaytAndEndOfDayAndAdresseDepartAndAdresseArrivee(
			@Param("startOfDay") LocalDateTime startOfDay, @Param("endOfDay") LocalDateTime endOfDay,
			@Param("adresseDepartId") Integer adresseDepartId,
			@Param("adresseArriveeId") Integer adresseArriveeId);

	/*
	 * @Query("SELECT c FROM Covoiturage c WHERE c.adresseArrivee.id =:adresseArrivee AND c.dateDepart BETWEEN :startOfDay AND :endOfDay AND c.dateDepart > CURRENT_DATE"
	 * ) public List<Covoiturage>
	 * findBeetweenStartOfDaytAndEndOfDayAndAdresseArrivee(@Param("startOfDay")
	 * LocalDateTime startOfDay, @Param("endOfDay") LocalDateTime
	 * endOfDay, @Param("adresseArrivee") Integer adresseArriveeId);
	 */
