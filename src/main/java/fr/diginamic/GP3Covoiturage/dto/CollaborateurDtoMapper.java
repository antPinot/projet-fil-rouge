...
public static Collaborateur toModel(CollaborateurDto collaborateurDto) {
		...
		Collaborateur model = new Collaborateur(collaborateurDto.getId(),
				collaborateurDto.getMatricule(),
				collaborateurDto.getNom(),
				collaborateurDto.getPrenom(),
				DateUtils.stringToLocalDate(collaborateurDto.getDateNaissance()),
				collaborateurDto.getTelephone(),
				collaborateurDto.getMail(),
				collaborateurDto.getLogin(),
				collaborateurDto.getPassword(),
